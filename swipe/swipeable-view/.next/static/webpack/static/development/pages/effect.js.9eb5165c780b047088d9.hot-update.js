        ...
        var height = position.interpolate({
          ...
          outputRange: inputRange.map(function (i) {
            if (currentIndex == _this2.state.index) {
              if (i == currentIndex) return 400;else return 200;
              /*
                              if (i == currentIndex)
                                return 400;
                              else
              ...
              */
              ...
              if (i == currentIndex) return 400;else return 400;
            }
          })
        });
...
//# sourceMappingURL=effect.js.9eb5165c780b047088d9.hot-update.js.map
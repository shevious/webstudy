...
class Course_info(models.Model):
    ...
    course_desc_url = models.CharField(null=True, max_length=4000) 
    ...
    '''
    edu_tm = models.CharField(max_length=200)
    edu_location_desc = models.CharField(max_length=4000)
    inquiry_tel_no = models.CharField(max_length=100)
    ...
    reg_user_id = models.CharField(max_length=30)
